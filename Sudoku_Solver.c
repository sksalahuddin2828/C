...
int isSafe(int grid[grid_size][grid_size], int row, int col, int num) {
    // Check if we find the same num in the same row, return 0
    ...
    // Check if we find the same num in the same column, return 0
    ...
    // Check if we find the same num in the particular 3x3 matrix, return 0
...
int solveSudoku(int grid[grid_size][grid_size], int row, int col) {
    // Check if we have reached the last row and column, return 1 to avoid further backtracking
